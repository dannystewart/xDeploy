...
struct AppData: Codable {
    static let empty: AppData = .init(projects: [], deviceConfig: .default, selectedProjectID: nil, customDeviceName: nil)
    ...
    /// The last used custom device name, restored on launch.
